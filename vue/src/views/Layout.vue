<template>
  <div>
    <!-- 头部区域 -->
    <div style="height: 60px; line-height: 60px; background-color: rgba(255, 255, 255, 0.95); margin-bottom: 2px; display: flex;">
      <div style="width: 300px">
        <img src="@/assets/logo.png" alt="" style="width: 40px; position: relative; top: 10px; left: 20px">
        <span style="margin-left: 25px; font-size: 24px">科城图书管理系统</span>
      </div>
    ...
    <div style="display: flex;">
      ...
      <div style="flex: 1; width: 0; background-color: rgba(255, 255, 255, 0.95); padding: 10px;">
        <router-view />
      </div>
    </div>
  </div>
